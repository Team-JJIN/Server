...
import com.JJIN.global.response.code.ErrorCode;
import com.JJIN.global.response.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
	@ExceptionHandler(JjinException.class)
	public ResponseEntity<ErrorResponse> handleMyException(JjinException e) {
	...
	public ResponseEntity<ErrorResponse> handleException(Exception e) {
		log.error("[Untreated Exception] ❌예기치 않은 서버 에러 발생: ", e);
